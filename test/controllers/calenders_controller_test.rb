...
class CalendersControllerTest < ActionController::TestCase
  ...
  test "should create calender" do
    assert_difference('Calender.count') do
      post :create, calender: { end_at: @calender.end_at, start_at: @calender.start_at, title: @calender.title, type: @calender.type }
    end
  ...
  test "should update calender" do
    patch :update, id: @calender, calender: { end_at: @calender.end_at, start_at: @calender.start_at, title: @calender.title, type: @calender.type }
    assert_redirected_to calender_path(assigns(:calender))
  end
